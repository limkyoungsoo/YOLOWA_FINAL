					...
					<div class="form-box" id="lForm">
						<div class="form-top">
							<div class="form-top-left">
								<h3>Forget Your ID</h3>
								<p>Enter user name and phone number to Forget ID:</p>
							</div>
						...
						<div class="form-bottom">
							<form role="form" action="forgotId.do" class="login-form" id="searchForm">
								<div class="form-group">
									<label class="sr-only" for="form-username">Username</label> <input
										type="text" id="name" name="name" placeholder="Username..." class="form-username" required="required">
								</div>
								<div class="form-group">
									...
									<input type="text" id="phone2" name="phone2" size="9" required="required"/>
									<input type="text" id="phone3" name="phone3" size="9" required="required"/>
									</div>
