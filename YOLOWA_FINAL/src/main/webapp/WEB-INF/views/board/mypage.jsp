	...
	<div class="profile-v1 col-md-12 col-sm-12 profile-v1-wrapper">
		<div class="col-md-9  profile-v1-cover-wrap"
			...
			<div class="col-md-12 profile-v1-cover">
				<img
					src="${pageContext.request.contextPath }/resources/asset/img/yolo2.jpg"
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="${pageContext.request.contextPath}/multifileupload.do" 
						method="post" enctype="multipart/form-data" id="fileUpload">
							사진<input type="file" name="file[0]"><br> 
							<input type="submit" value="멀티파일업로드"> 
							<input type="hidden" name="userInfo" value='${user.id }'>
						</form>
					</div>
...
<div class="row">
									...
									<c:choose>
										<c:when test="${user.id==bList.id}">
											<c:if test="${bList.fTitle ne '0'}">
												<li><a
													href="modifyFundingView.do?bNo=${bList.bNo}&type=mypage">
											...
											<c:if test="${bList.fTitle eq '0'}">
												<li><a
													href="modifyContentView.do?bNo=${bList.bNo}&type=mypage">
														<span class="fa fa-refresh"></span> 수정
												</a></li>
												<li><a href="deleteMypage.do?bNo=${bList.bNo}"><span
														class="fa fa-trash-o"></span> 삭제 </a></li>
										...
										<c:otherwise>
											<li><a onclick="bookMark('${bList.bNo}')" href="#"><span
													class="" id="bookMark${bList.bNo}"> </span></a></li>
										</c:otherwise>
									</c:choose>
								</ul></li>
						</ul>
	...
	<!--  친구 목록 -->
	<div class="col-sm-4" style="width: 400px; margin-left: 50px">
		<c:set value="${requestScope.requestList.friends }" var="flist"></c:set>
			...
			<div class="panel divArea">
				...
				<c:forEach items="${flist}" var="fList">
					<div class="col-md-6 padding-0">
						<div class="badges-v1" style="height: 250px; width: 150px;">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="modal-footer">
					<div style="display: inline-block; width: 25%; height: 30px; text-align: right; font-size: 12pt;">
