 ...
 * 
 * getTotalPage()<br>
 * 총 페이지 수 getTotalPageGroup()<br>
 * 총 페이지 그룹 수 getNowPageGroup()<br>
 * 현재 페이지 그룹
 * 
...
public class PagingBean {
	...
	public int getStartRowNumber() {
		// // 총 게시물 수 47, 현재 페이지 10
		int startRowNum = 0;
		startRowNum = (nowPage - 1) * contentNumberPerPage + 1;
		return startRowNum;
	}
	...
	public int getEndRowNumber() {
		int endRowNumber = 0;
		endRowNumber = nowPage * contentNumberPerPage;
	...
	public int getTotalPageGroup() {
		...
		if (totalPage % pageNumberPerPageGroup > 0) {
			totalPageGroup = (totalPage / pageNumberPerPageGroup) + 1;
		} else {
			totalPageGroup = totalPage % pageNumberPerPageGroup;
		}
	...
	public int getStartPageOfPageGroup() {
		int num = 0;
		num = pageNumberPerPageGroup * (this.getNowPageGroup() - 1) + 1;
		return num;
	}
	...
	public int getEndPageOfPageGroup() {
		int num = 0;
		num = getNowPageGroup() * pageNumberPerPageGroup;
		// 페이지 그룹*페이지 그룹 개수
		if (getTotalPage() < num) {
			num = getTotalPage();
		}
